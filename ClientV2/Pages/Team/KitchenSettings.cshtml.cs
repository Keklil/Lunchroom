...
public class KitchenSettings : PageModel
{
    ...
    [BindProperty] public TimeOnly MenuExpired { get; set; }

    [BindProperty] public PeriodicRefresh PeriodicRefresh { get; set; }

    public SelectList PeriodicRefreshList => PeriodicRefresh.ToEnumDescriptionsList();

    [BindProperty] public MenuFormat MenuFormat { get; set; }
    ...
    public async Task<ActionResult> OnPostAsync()
    {
        ...
        await _api.Group_ConfigureKitchenAsync(settings);
