...
namespace Data.Migrations
{
    ...
    [Migration("20230515185312_AddAllowMultipleSelectionFlag")]
    partial class AddAllowMultipleSelectionFlag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Option", b =>
                {
                    ...
                    b.Property<bool>("AllowMultipleSelectionInOneLunchSet")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Models.Kitchen", b =>
                {
                    ...
                    b.OwnsOne("Domain.Models.KitchenSettings", "Settings", b1 =>
                        {
                            b1.Property<Guid>("KitchenId")
                                .HasColumnType("uuid");

                            b1.Property<TimeSpan>("LimitingTimeForOrder")
                                .HasColumnType("interval");

                            b1.Property<int>("MenuFormat")
                                .HasColumnType("integer");

                            b1.Property<int>("MenuUpdatePeriod")
                                .HasColumnType("integer");

                            b1.Property<decimal?>("MinAmountForSharedOrder")
                                .HasColumnType("numeric");
                            ...
                            b1.OwnsMany("Domain.Models.ShippingArea", "ShippingAreas", b2 =>
                                {
                                    b2.Property<Guid>("KitchenSettingsKitchenId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.Property<Polygon>("Polygon")
                                        .IsRequired()
                                        .HasColumnType("geometry (polygon)");

                                    b2.HasKey("KitchenSettingsKitchenId", "Id");

                                    b2.ToTable("ShippingArea");

                                    b2.WithOwner()
                                        .HasForeignKey("KitchenSettingsKitchenId");
                                });

                            b1.Navigation("ShippingAreas");
                        });
            ...
            modelBuilder.Entity("Domain.Models.Order", b =>
                {
                    ...
                    b.OwnsMany("Domain.Models.OrderDish", "Dishes", b1 =>
                        {
                            ...
                            b1.ToTable("OrderDish");

                            b1.WithOwner()
                                .HasForeignKey("OrderId");
                        });

                    b.OwnsMany("Domain.Models.OrderLunchSet", "LunchSets", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<Guid>("MenuLunchSetId")
                                .HasColumnType("uuid");

                            b1.HasKey("OrderId", "Id");

                            b1.ToTable("OrderLunchSet");

                            b1.WithOwner()
                                .HasForeignKey("OrderId");

                            b1.OwnsMany("Domain.Models.OrderOption", "Options", b2 =>
                                {
                                    b2.Property<Guid>("OrderLunchSetOrderId")
                                        .HasColumnType("uuid");

                                    b2.Property<int>("OrderLunchSetId")
                                        .HasColumnType("integer");
                                    ...
                                    b2.Property<Guid>("MenuOptionId")
                                        .HasColumnType("uuid");

                                    b2.Property<int>("Quantity")
                                        .HasColumnType("integer");

                                    b2.HasKey("OrderLunchSetOrderId", "OrderLunchSetId", "Id");

                                    b2.ToTable("OrdersOptions");

                                    b2.WithOwner()
                                        .HasForeignKey("OrderLunchSetOrderId", "OrderLunchSetId");
                                });
